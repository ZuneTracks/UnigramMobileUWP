    ...
    public class TLNavigationService : NavigationService
    {
        ...
        public async void NavigateToChat(Chat chat, long? message = null, long? thread = null, string accessToken = null, IDictionary<string, object> state = null, bool scheduled = false, bool force = true)
        {
            ...
            else if (chat.Type is ChatTypeSupergroup super)
            {
                ...
                if (supergroup.Status is ChatMemberStatusLeft && string.IsNullOrEmpty(supergroup.GetUsername()) && !supergroup.HasLocation && !supergroup.HasLinkedChat && !_protoService.IsChatAccessible(chat))
                {
